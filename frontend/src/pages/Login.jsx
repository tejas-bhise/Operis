  ...
  return (
    <div style={{ minHeight:'100vh', background:'#050505', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'Inter,-apple-system,sans-serif', padding:24 }}>
      <div style={{ width:'100%', maxWidth:400 }}>
        ...
        <h1 style={{ fontSize:26, fontWeight:700, color:'#f5f5f5', letterSpacing:'-0.04em', marginBottom:8 }}>Welcome back</h1>
        <p style={{ fontSize:14, color:'#52525b', marginBottom:36 }}>Sign in to your Operis account</p>
